...
public class BoletaDAOImpl implements BoletaDAO {
	...
	@Override
	public Widget cantidadBoletasNoLeidas(String idCompania, String idSucursal, String idEmpleado,
			ConfiguracionDataSource configuracionDataSource) {
		Widget widget = null;
		Connection conexion = null;

		String query = lector.leerPropiedad("queries/boleta.query").getProperty("cantidadNoLeidas");
